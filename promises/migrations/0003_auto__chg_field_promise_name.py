...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promise.name'
        db.alter_column(u'promises_promise', 'name', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'Promise.name'
        db.alter_column(u'promises_promise', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))
