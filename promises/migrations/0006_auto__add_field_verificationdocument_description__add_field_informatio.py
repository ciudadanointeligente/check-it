...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerificationDocument.description'
        db.add_column(u'promises_verificationdocument', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'InformationSource.description'
        db.add_column(u'promises_informationsource', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerificationDocument.description'
        db.delete_column(u'promises_verificationdocument', 'description')

        # Deleting field 'InformationSource.description'
        db.delete_column(u'promises_informationsource', 'description')
    ...
    models = {
        ...
        u'promises.milestone': {
            'Meta': {'ordering': "('date',)", 'object_name': 'Milestone'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'promises.promise': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Promise'},
