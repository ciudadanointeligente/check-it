...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VerificationDocument.fulfillment'
        db.delete_column(u'deldichoalhecho_verificationdocument', 'fulfillment_id')

        # Adding field 'VerificationDocument.promise'
        db.add_column(u'deldichoalhecho_verificationdocument', 'promise',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='verification_documents', null=True, to=orm['deldichoalhecho.Promise']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VerificationDocument.fulfillment'
        raise RuntimeError("Cannot reverse this migration. 'VerificationDocument.fulfillment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VerificationDocument.fulfillment'
        db.add_column(u'deldichoalhecho_verificationdocument', 'fulfillment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deldichoalhecho.Fulfillment']),
                      keep_default=False)

        # Deleting field 'VerificationDocument.promise'
        db.delete_column(u'deldichoalhecho_verificationdocument', 'promise_id')
